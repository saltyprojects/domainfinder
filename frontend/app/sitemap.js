...
export default async function sitemap() {
  ...
  const staticPages = [
    ...
    { url: `${base}/domain-appraisal`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.8 },
    { url: `${base}/reverse-whois`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.8 },
    { url: `${base}/txt-record-lookup`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.8 },
    ...
    { url: `${base}/response-time`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.8 },

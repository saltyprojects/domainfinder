...
const REGISTRARS = [
  { name: 'Namecheap', url: (d) => `https://www.anrdoezrs.net/click-101695072-15083053?url=${encodeURIComponent('https://www.namecheap.com/domains/registration/results/?domain=' + d)}` },
              ...
              {available.map(r => (
                <div key={r.full_domain} style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <a href={`${(() => { const AFFILIATE_URL='https://www.anrdoezrs.net/click-101695072-15083053'; return `${AFFILIATE_URL}?url=${encodeURIComponent('https://www.namecheap.com/domains/registration/results/?domain='+r.full_domain)}`; })()}`}
